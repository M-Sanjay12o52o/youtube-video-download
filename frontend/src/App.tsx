  ...
  return (
    <div className='bg-yellow-500 flex flex-col justify-center items-center min-h-screen'>
      <div className="flex flex-row justify-center items-center">
        <div>
          <img src="/download.png" alt="logo" className='w-20 h-20' />
        </div>
        <div className="text-4xl font-bold">
          <h1>
            Chance <span data-testid="youtube" className='text-red-700'>Youtube</span> downloader
          </h1>
        </div>
      </div>
      <div className="flex flex-row">
        <div>
          <input
            ...
            className='outline-none p-2 bg-yellow-200 border-2 border-gray-500 rounded-md md:mr-4'
          />
        </div>
      ...
      <div>
        {data !== null ? (
          <div>
            <div className="my-4">
              <iframe width={570} height={320} src={`${data.data.url}`} title='video' />
            </div>
            <div>
